...
if ($#ARGV < 7)
{
    ...
    print "usage: run_condor.pl <events> <runnumber> <segment> <outfile> <outdir> <qafile1> <qafile2> <qadir>\n";
    print "options:\n";
...
print F "Arguments       = \"$nevents $runnumber $segment $dstoutfile $dstoutdir $qafile1 $qafile2 $qadir\"\n";
...
print F "$executable, $nevents, $runnumber, $segment, $dstoutfile, $dstoutdir, $qafile1, $qafile2, $qadir, $errfile, $outfile, $condorlogfile, $rundir, $baseprio, $batchname\n";
close(F);
