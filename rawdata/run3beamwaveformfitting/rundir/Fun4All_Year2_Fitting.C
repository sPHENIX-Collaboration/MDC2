...
void Fun4All_Year2_Fitting(int nEvents = 100,
			   const std::string inlist = "files.list",
                           const std::string &outfile = "DST_CALOFITTING_run3beam_ana491_2025p002_v004-00054530-00000.root",
                           const std::string &outfile_hist = "HIST_CALOFITTINGQA_run3beam_ana491_2025p002_v004-00054530-00000.root",
