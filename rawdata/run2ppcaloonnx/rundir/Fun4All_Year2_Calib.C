...
void Fun4All_Year2_Calib(int nEvents = 100,
                         const std::string &fname = "DST_CALOFITTING_ONNX_run2pp_new_newcdbtag_v008-00047289-00000.root",
                         const std::string &outfile = "DST_CALO_ONNX_run2pp_new_newcdbtag_v008-00047289-00000.root",
                         const std::string &outfile_hist = "HIST_CALOQA_ONNX_run2pp_new_newcdbtag_v008-00047289-00000.root",
