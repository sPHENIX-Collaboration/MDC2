...
{
    print "found $res[0]\n";
    if ($res[0] =~ /DST_TRIGGERED_EVENT/ && ($res[0] =~ /run3beam_ana516_nocdbtag_v001/ || $res[0] =~ /run3pp_ana516_nocdbtag_v001/ || $res[0] =~ /run3beam_ana527_nocdbtag_v001/ || $res[0] =~ /run3pp_ana527_nocdbtag_v001/))
    {
