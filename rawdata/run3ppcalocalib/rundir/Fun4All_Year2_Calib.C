...
void Fun4All_Year2_Calib(int nEvents = 100,
                         const std::string &fname = "DST_CALOFITTING_run3pp_new_newcdbtag_v008-00067507-00000.root",
                         const std::string &outfile = "DST_CALO_run3pp_new_newcdbtag_v008-00067507-00000.root",
                         const std::string &outfile_hist = "HIST_CALOQA_run3pp_new_newcdbtag_v008-00067507-00000.root",
                         const std::string &outfile_sepd = "CALIB_EVENTPLANE_run3pp_new_newcdbtag_v008-00067507-00000.root",
