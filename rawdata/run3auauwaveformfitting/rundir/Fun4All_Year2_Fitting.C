...
void Fun4All_Year2_Fitting(int nEvents = 100,
			   const std::string inlist = "files.list",
                           const std::string &outfile = "DST_CALOFITTING_run3auau_new_newcdbtag_v006-00054530-00000.root",
                           const std::string &outfile_hist = "HIST_CALOFITTINGQA_run3auau_new_newcdbtag_v006-00054530-00000.root",
