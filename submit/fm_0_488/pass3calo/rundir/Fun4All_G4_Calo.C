...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_sHijing_0_488fm_50kHz_bkg_0_20fm-0000000010-00000.root",
    const string &outputFile = "DST_CALO_CLUSTER_sHijing_0_488fm_50kHz_bkg_0_20fm-0000000010-00000.root",
    const string &outdir = ".",
