...
void Fun4All_TruthReco(
  const int nEvents = 0,
  const std::string &dst_trkr_g4hit = "DST_TRKR_G4HIT_sHijing_0_488fm-0000000007-00000.root",
  const std::string &dst_trkr_cluster = "DST_TRKR_CLUSTER_sHijing_0_488fm-0000000007-00000.root",
  const std::string &dst_tracks = "DST_TRACKS_sHijing_0_488fm-0000000007-00000.root",
  const std::string &dst_truth = "DST_TRUTH_sHijing_0_488fm-0000000007-00000.root",
  const std::string &outputFile = "DST_TRUTH_RECO_sHijing_0_488fm-0000000007-00000.root",
