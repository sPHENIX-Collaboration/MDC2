...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const string &inputFile = "DST_TRKR_CLUSTER_sHijing_0_488fm-0000000007-00000.root",
  const string &outputFile = "DST_TRACKSEEDS_sHijing_0_488fm-0000000007-00000.root",
  const string &outdir = "."
  )
{
