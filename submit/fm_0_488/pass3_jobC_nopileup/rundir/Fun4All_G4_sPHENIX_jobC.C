...
int Fun4All_G4_sPHENIX_jobC(
  ...
  const std::string &inputFile1 = "DST_TRACKSEEDS_sHijing_0_488fm-0000000007-00000.root",
  const std::string &inputFile2 = "DST_CALO_CLUSTER_sHijing_0_488fm-0000000007-00000.root",
  const std::string &outputFile = "DST_TRACKS_sHijing_0_488fm-0000000007-00000.root",
