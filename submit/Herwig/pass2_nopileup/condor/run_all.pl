...
#            print "checking for $lfn\n";
	...
	my $calooutfilename = sprintf("DST_CALO_CLUSTER_Herwig_%s-%010d-%06d.root",$jettrigger,$runnumber,$segment);
	my $globaloutfilename = sprintf("DST_MBD_EPD_Herwig_%s-%010d-%06d.root",$jettrigger,$runnumber,$segment);
