...
void Fun4All_G4_Jets(
  const int nEvents = 0,
  const std::string &inputFile = "DST_TRUTH_Herwig_MB_200kHz-0000000029-000000.root",
  const std::string &outputFile = "DST_TRUTH_JETS_Herwig_MB_200kHz-0000000029-000000.root",
