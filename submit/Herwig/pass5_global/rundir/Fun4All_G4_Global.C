...
int Fun4All_G4_Global(
    const int nEvents = 0,
    const std::string &inputFile1 = "DST_TRACKS_Herwig_MB_200kHz-0000000022-000000.root",
    const std::string &inputFile2 = "DST_MBD_EPD_Herwig_MB_200kHz-0000000022-000000.root",
    const std::string &outputFile = "DST_GLOBAL_Herwig_MB_200kHz-0000000022-000000.root",
