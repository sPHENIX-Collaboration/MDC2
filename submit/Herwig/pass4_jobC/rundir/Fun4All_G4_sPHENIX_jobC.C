...
int Fun4All_G4_sPHENIX_jobC(
  ...
  const std::string &inputFile1 = "DST_TRACKSEEDS_Herwig_MB_200kHz-0000000029-000000.root",
  const std::string &inputFile2 = "DST_CALO_CLUSTER_Herwig_MB_200kHz-0000000029-000000.root",
  const std::string &outputFile = "DST_TRACKS_Herwig_MB_200kHz-0000000029-000000.root",
