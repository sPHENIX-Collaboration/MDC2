...
int Fun4All_G4_sPHENIX_job0(
  ...
  const std::string &inputFile = "DST_TRKR_HIT_Herwig_MB_200kHz-0000000029-000000.root",
  const std::string &outputFile = "DST_TRKR_CLUSTER_Herwig_MB_200kHz-0000000029-000000.root",
