...
int Fun4All_G4_Pass3Trk(
    const int nEvents = 1,
    const std::string &inputFile0 = "DST_TRKR_G4HIT_Herwig_MB_200kHz-0000000028-000000.root",
    const std::string &inputFile1 = "DST_TRUTH_G4HIT_Herwig_MB_200kHz-0000000028-000000.root",
