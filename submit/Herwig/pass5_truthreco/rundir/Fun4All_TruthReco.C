...
void Fun4All_TruthReco(
  const int nEvents = 0,
  const std::string &dst_trkr_g4hit = "DST_TRKR_G4HIT_Herwig_MB_200kHz-0000000029-00000.root",
  const std::string &dst_trkr_cluster = "DST_TRKR_CLUSTER_Herwig_MB_200kHz-0000000029-00000.root",
  const std::string &dst_tracks = "DST_TRACKS_Herwig_MB_200kHz-0000000029-00000.root",
  const std::string &dst_truth = "DST_TRUTH_Herwig_MB_200kHz-0000000029-00000.root",
  const std::string &outputFile = "DST_TRUTH_RECO_Herwig_MB_200kHz-0000000029-00000.root",
