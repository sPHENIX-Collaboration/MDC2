...
void CreateDstOutput(int runnumber, int segment, const std::string &jettrigger)
{
  ...
  std::string FullOutFile = "DST_BBC_G4HIT_Herwig_" + segrun + ".root";
  ...
  FullOutFile = "DST_TRKR_G4HIT_Herwig_" + segrun + ".root";
  ...
  FullOutFile = "DST_CALO_G4HIT_Herwig_" + segrun + ".root";
  ...
  FullOutFile = "DST_TRUTH_G4HIT_Herwig_" + segrun + ".root";
