...
if ($system < 1 || $system > 49)
{
    ...
    print "   48 : JS pythia8 Jet >3GeV\n";
    print "   49 : JS pythia8 PhotonJet > 3GeV\n";
    exit(0);
}
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "pythia8_Jet12";
    if (defined $double)
    {
	$systemstring_g4hits = sprintf("%s_pythia8_Detroit",$systemstring_g4hits);
    }
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "Herwig_Jet5";
    if (! defined $nopileup)
    {
	    if (defined $embed)
	    {
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "Herwig_Jet12";
    if (! defined $nopileup)
    {
	    if (defined $embed)
	    {
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "Herwig_Jet20";
    if (! defined $nopileup)
    {
	    if (defined $embed)
	    {
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "Herwig_Jet40";
    if (! defined $nopileup)
    {
	    if (defined $embed)
	    {
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "Herwig_Jet50";
    if (! defined $nopileup)
    {
	    if (defined $embed)
	    {
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "pythia8_Jet3";
    if (defined $double)
    {
	$systemstring_g4hits = sprintf("%s_pythia8_Detroit",$systemstring_g4hits);
    }
...
{
    $g4hits_exist = 1;
    $systemstring_g4hits = "pythia8_PhotonJet3";
    if (defined $double)
    {
	$systemstring_g4hits = sprintf("%s_pythia8_Detroit",$systemstring_g4hits);
    }
...
if (defined $double)
{
    $gpfsdir = sprintf("%s_double",$gpfsdir);
}
