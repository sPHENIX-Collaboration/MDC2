...
my $getfiles = $dbh->prepare("select filename,segment from datasets where dsttype = 'DST_TRKR_HIT' and filename like 'DST_TRKR_HIT_sHijing_0_20fm-%' and runnumber = $runnumber order by filename") || die $DBI::errstr;
