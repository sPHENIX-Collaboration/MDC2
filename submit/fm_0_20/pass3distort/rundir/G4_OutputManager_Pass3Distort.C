...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = "DST_TRUTH_DISTORT_sHijing_0_20fm_50kHz_bkg_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_HIT_DISTORT_sHijing_0_20fm_50kHz_bkg_0_20fm-" + string(segrun) + ".root";;
