...
void Fun4All_G4_Waveform(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000019-000000.root",
    const string &inputFile1 = "pedestal-00046796.root",  
    const string &outputFile = "DST_CALO_WAVEFORM_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000019-000000.root",
    const string &outdir = ".",
