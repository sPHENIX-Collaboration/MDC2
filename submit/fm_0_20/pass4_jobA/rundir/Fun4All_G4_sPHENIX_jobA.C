...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const char* inputFile = "DST_TRKR_CLUSTER_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000004-00000_test.root",
  const char* outputFile = "DST_TRACKSEEDS_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000004-00000_test.root",
  const string &outdir = "."
  )
{
