...
int Fun4All_G4_Global(
    const int nEvents = 0,
    const std::string &inputFile1 = "DST_TRACKS_sHijing_0_20fm-0000000007-00000.root",
    const std::string &inputFile2 = "DST_BBC_EPD_sHijing_0_20fm-0000000007-00000.root",
    const std::string &outputFile = "DST_GLOBAL_sHijing_0_20fm-0000000007-00000.root",
