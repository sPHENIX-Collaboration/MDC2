...
print F "$executable, $nevents, $infile, $backgroundlist, $dstoutdir, $build, $runnumber, $sequence, $outfile, $errfile, $condorlogfile, $rundir, $baseprio\n";
close(F);
