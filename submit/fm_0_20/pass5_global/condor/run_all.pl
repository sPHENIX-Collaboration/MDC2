...
my $getmbdepdfiles = $dbh->prepare("select filename,segment from datasets where dsttype = 'DST_MBD_EPD' and filename like 'DST_MBD_EPD_sHijing_0_20fm_50kHz_bkg_0_20fm%' and runnumber = $inrunnumber");
