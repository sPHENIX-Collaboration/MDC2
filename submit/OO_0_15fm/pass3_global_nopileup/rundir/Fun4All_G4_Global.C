...
int Fun4All_G4_Global(
    const int nEvents = 0,
    const std::string &inputFile = "DST_BBC_EPD_sHijing_OO_0_15fm-0000000030-000000.root",
    const std::string &outputFile = "DST_GLOBAL_sHijing_OO_0_15fm-0000000030-000000.root",
