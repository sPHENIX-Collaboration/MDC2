...
int Fun4All_G4_sPHENIX_job0(
    ...
    const std::string &inputFile = "DST_TRKR_HIT_sHijing_OO_0_15fm-0000000035-000000.root",
    const std::string &outputFile = "DST_TRKR_CLUSTER_sHijing_OO_0_15fm-0000000035-000000.root",
