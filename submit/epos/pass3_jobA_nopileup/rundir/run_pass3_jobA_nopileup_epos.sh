...
source /cvmfs/sphenix.sdcc.bnl.gov/gcc-12.1.0/opt/sphenix/core/bin/sphenix_setup.sh -n ana.399
...
timedirname=/sphenix/sim/sim01/sphnxpro/mdc2/logs/epos/pass3_jobA_nopileup/timing.run${runnumber}
if [ ! -d $timedirname ]
then
  mkdir -p $timedirname
fi
