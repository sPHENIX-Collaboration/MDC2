...
my $getfiles = $dbh->prepare("select filename,segment from datasets where dsttype = 'DST_TRKR_HIT' and filename like 'DST_TRKR_HIT_epos_0_153fm-%' and runnumber = $runnumber order by segment") || die $DBI::errstr;
