...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const string &inputFile = "DST_TRKR_CLUSTER_epos_0_153fm_50kHz_bkg_0_153fm-0000000006-00000.root",
  const string &outputFile = "DST_TRACKSEEDS_epos_0_153fm_50kHz_bkg_0_153fm-0000000006-00000.root",
  const string &outdir = "."
  )
{
