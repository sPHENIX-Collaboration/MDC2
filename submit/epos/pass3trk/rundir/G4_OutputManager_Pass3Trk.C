...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = "DST_TRUTH_epos_0_153fm_50kHz_bkg_0_153fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_HIT_epos_0_153fm_50kHz_bkg_0_153fm-" + string(segrun) + ".root";;
