...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_epos_0_153fm_50kHz_bkg_0_153fm-0000000010-00000.root",
    const string &outputFile = "DST_CALO_CLUSTER_epos_0_153fm_50kHz_bkg_0_153fm-0000000010-00000.root",
    const string &outdir = ".")
{
