...
if ($#ARGV < 3)
{
    print "usage: run_condor.pl <events> <runnumber> <sequence> <indir>\n";
    print "options:\n";
...
print F "Arguments       = \"$nevents $runnumber $sequence $indir\"\n";
...
print F "Environment = \"HTCondor_Job_ID=\$(ClusterId).\$(ProcId)\"\n";
