...
int Fun4All_G4_BBC_EPD(
    const int nEvents = 1,
    const string &inputFile1 = "DST_BBC_G4HIT_pythia8_pp_mb_3MHz-0000000008-00000.root",
    const string &inputFile2 = "DST_TRUTH_G4HIT_pythia8_pp_mb_3MHz-0000000008-00000.root",
    const string &outputFile = "DST_BBC_EPD_pythia8_pp_mb_3MHz-0000000008-00000.root",
    const string &outdir = ".")
{
