...
int Fun4All_G4_MBD_EPD(
    const int nEvents = 1,
     const string &inputFile1 = "DST_BBC_G4HIT_pythia8_pp_mb_3MHz-0000000011-00000.root",
     const string &inputFile2 = "DST_TRUTH_G4HIT_pythia8_pp_mb_3MHz-0000000011-00000.root",
     const string &outputFile = "DST_MBD_EPD_pythia8_pp_mb_3MHz-0000000011-00000.root",
    const string &outdir = ".")
{
