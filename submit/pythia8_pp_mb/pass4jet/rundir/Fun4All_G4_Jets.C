...
void Fun4All_G4_Jets(
  const int nEvents = 0,
  const string &inputFile = "DST_TRUTH_pythia8_pp_mb_3MHz-0000000011-00000.root",
  const string &outputFile = "DST_TRUTH_JETS_pythia8_pp_mb_3MHz-0000000011-00000.root",
  const string &outdir = "."
  )
{
