...
void Fun4All_G4_Jets(
  ...
  const string &inputFile = "DST_TRUTH_pythia8_pp_mb_3MHz-0000000040-00000.root",
  const string &outputFile = "DST_TRUTH_JETS_pythia8_pp_mb_3MHz-0000000040-00000.root",
  const string &outdir = "."
  )
{
