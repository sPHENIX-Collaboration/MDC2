...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = "DST_BBC_G4HIT_pythia8_pp_mb_1MHz-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_G4HIT_pythia8_pp_mb_1MHz-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_CALO_G4HIT_pythia8_pp_mb_1MHz-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRUTH_G4HIT_pythia8_pp_mb_1MHz-" + string(segrun) + ".root";;
