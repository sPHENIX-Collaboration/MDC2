...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_pythia8_pp_mb_3MHz-0000000007-00000.root",
    const string &outputFile = "DST_CALO_CLUSTER_pythia8_pp_mb_3MHz-0000000007-00000.root",
    const string &outdir = ".")
{
