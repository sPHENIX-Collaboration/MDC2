...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const string &inputFile = "DST_TRKR_CLUSTER_pythia8_pp_mb_3MHz-0000000062-00000.root",
  const string &outputFile = "DST_TRACKSEEDS_pythia8_pp_mb_3MHz-0000000062-00000.root",
  const string &outdir = "."
  )
{
