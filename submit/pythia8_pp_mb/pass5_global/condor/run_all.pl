...
my $getbbcepdfiles = $dbh->prepare("select filename,segment from datasets where dsttype = 'DST_BBC_EPD' and filename like 'DST_BBC_EPD_pythia8_pp_mb_3MHz%' and runnumber = $inrunnumber");
