...
int Fun4All_G4_Pass3Trk(
  const int nEvents = 0,
  const string &inputFile0 = "DST_TRKR_G4HIT_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-0000000009-00000.root",
  const string &inputFile1 = "DST_TRUTH_G4HIT_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-0000000009-00000.root",
  const string &outdir = ".")
{
