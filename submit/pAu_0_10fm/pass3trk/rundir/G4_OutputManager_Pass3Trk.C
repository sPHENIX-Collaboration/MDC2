...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = "DST_TRUTH_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_HIT_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-" + string(segrun) + ".root";;
