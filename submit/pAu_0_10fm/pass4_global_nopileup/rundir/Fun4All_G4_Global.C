...
int Fun4All_G4_Global(
    const int nEvents = 0,
    const std::string &inputFile1 = "DST_TRACKS_sHijing_pAu_0_10fm-0000000009-00000.root",
    const std::string &inputFile2 = "DST_BBC_EPD_sHijing_pAu_0_10fm-0000000009-00000.root",
    const std::string &outputFile = "DST_GLOBAL_sHijing_pAu_0_10fm-0000000009-00000.root",
