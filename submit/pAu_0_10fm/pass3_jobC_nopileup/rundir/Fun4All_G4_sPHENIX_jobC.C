...
int Fun4All_G4_sPHENIX_jobC(
  ...
  const std::string &inputFile1 = "DST_TRACKSEEDS_sHijing_pAu_0_10fm-0000000009-00000.root",
  const std::string &inputFile2 = "DST_CALO_CLUSTER_sHijing_pAu_0_10fm-0000000009-00000.root",
  const std::string &outputFile = "DST_TRACKS_sHijing_pAu_0_10fm-0000000009-00000.root",
