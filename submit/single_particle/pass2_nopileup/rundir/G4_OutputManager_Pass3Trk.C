...
void CreateDstOutput(int runnumber, int segment, const string &filetype)
{
  auto se = Fun4AllServer::instance();

  char segrun[100];
  snprintf(segrun,100,"%s-%010d-%05d",filetype.c_str(),runnumber,segment);
  string FullOutFile = "DST_TRUTH_" + string(segrun) + ".root";;
