...
void CreateDstOutput(int runnumber, int segment, const string &particle)
{
  auto se = Fun4AllServer::instance();

  char segrun[100];
  snprintf(segrun,100,"%010d-%05d",runnumber,segment);
  string FullOutFile = "DST_BBC_G4HIT_" + particle + "_sHijing_0_20fm_50kHz_bkg_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_G4HIT_" + particle + "_sHijing_0_20fm_50kHz_bkg_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_CALO_G4HIT_" + particle + "_sHijing_0_20fm_50kHz_bkg_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRUTH_G4HIT_" + particle + "_sHijing_0_20fm_50kHz_bkg_0_20fm-" + string(segrun) + ".root";;
