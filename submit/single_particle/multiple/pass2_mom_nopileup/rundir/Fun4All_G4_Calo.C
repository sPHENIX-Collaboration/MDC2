...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "G4Hits_single_gamma_p_5000_40000MeV-0000000007-00000.root",
    const string &outputFile = "DST_CALO_CLUSTER_single_gamma_p_5000_40000MeV-0000000007-00000.root",
    const string &outdir = ".")
{
