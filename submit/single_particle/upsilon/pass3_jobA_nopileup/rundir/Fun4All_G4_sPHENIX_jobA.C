...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const string &inputFile = "DST_TRKR_CLUSTER_single_upsilon-0000000063-00000.root",
  const string &outputFile = "DST_TRACKSEEDS_single_upsilon-0000000063-00000.root",
  const string &outdir = "."
  )
{
