...
if ($#ARGV < 7)
{
    print "usage: run_condor.pl <events> <particle> <ptmin> <ptmax> <trk infile> <truth infile> <outdir> <runnumber> <sequence>\n";
    print "options:\n";
...
print F "Arguments       = \"$nevents $particle $ptmin $ptmax $infile0 $infile1 $dstoutdir $particle $runnumber $sequence\"\n";
