...
void Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "G4Hits_ampt_0_20fm-0000000026-000000.root",
    const string &outputFile = "DST_CALO_CLUSTER_ampt_0_20fm-0000000026-0000000022-000000.root",
    const string &outdir = ".",
