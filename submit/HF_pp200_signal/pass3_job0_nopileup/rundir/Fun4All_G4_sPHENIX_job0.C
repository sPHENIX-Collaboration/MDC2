...
int Fun4All_G4_sPHENIX_job0(
  ...
  const std::string &inputFile = "DST_TRKR_HIT_pythia8_Charm-0000000006-00000.root",
  const std::string &outputFile = "DST_TRKR_CLUSTER_pythia8_Charm-0000000006-00000.root",
  const string &outdir = ".")
{
