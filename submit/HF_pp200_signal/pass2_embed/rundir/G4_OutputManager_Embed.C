...
void CreateDstOutput(int runnumber, int segment, const string &quarkfilter, const string &fmrange)
{
  ...
  string FullOutFile = "DST_BBC_G4HIT_pythia8_" + quarkfilter + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_G4HIT_pythia8_" + quarkfilter + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_CALO_G4HIT_pythia8_" + quarkfilter + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRUTH_G4HIT_pythia8_" + quarkfilter + string(segrun) + ".root";;
