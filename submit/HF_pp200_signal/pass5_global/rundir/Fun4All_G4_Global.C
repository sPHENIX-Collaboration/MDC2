...
int Fun4All_G4_Global(
    const int nEvents = 0,
    const std::string &inputFile1 = "DST_TRACKS_pythia8_Charm_3MHz-0000000008-00000.root",
    const std::string &inputFile2 = "DST_BBC_EPD_pythia8_Charm_3MHz-0000000008-00000.root",
    const std::string &outputFile = "DST_GLOBAL_pythia8_Charm_3MHz-0000000008-00000.root",
