...
R__LOAD_LIBRARY(libffamodules.so)
  ...
  void Fun4All_G4_Jets(
    const int nEvents = 0,
    const string &inputFile = "DST_TRUTH_pythia8_CharmD0piKJet5-0000000007-00000.root",
    const string &outputFile = "DST_TRUTH_JETS_pythia8_CharmD0piKJet5-0000000007-00000.root",
    const string &outdir = "."
    )
{
