...
void CreateDstOutput(int runnumber, int segment, const string &jettrigger)
{
  ...
  string FullOutFile = "DST_TRUTH_pythia8_" + jettrigger + "_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_HIT_pythia8_" + jettrigger + "_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-" + string(segrun) + ".root";;
