...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_pythia8_Jet30_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-0000000009-00000.root",
    const string &outputFile = "DST_CALO_CLUSTER_pythia8_Jet30_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-0000000009-00000.root",
    const string &outdir = ".")
{
