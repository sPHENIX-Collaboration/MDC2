...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const string &inputFile = "DST_TRKR_CLUSTER_pythia8_Jet10_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-0000000006-00000.root",
  const string &outputFile = "DST_TRACKSEEDS_pythia8_Jet10_sHijing_pAu_0_10fm_500kHz_bkg_0_10fm-0000000006-00000.root",
  const string &outdir = "."
  )
{
