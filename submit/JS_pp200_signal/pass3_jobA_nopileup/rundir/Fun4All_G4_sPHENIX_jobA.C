...
int Fun4All_G4_sPHENIX_jobA(
  ...
  const string &inputFile = "DST_TRKR_CLUSTER_pythia8_Jet30-0000000028-000000.root",
  const string &outputFile = "DST_TRACKSEEDS_pythia8_Jet30-0000000028-000000.root",
  const string &outdir = ".",
