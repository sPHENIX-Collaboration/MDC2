...
print F "$executable, $nevents, $infile0,  $infile1, $infile2, $infile3, $outfilename, $dstoutdir, $build, $runnumber, $sequence, $jettrigger, $outfile, $errfile, $condorlogfile, $rundir, $baseprio\n";
close(F);
