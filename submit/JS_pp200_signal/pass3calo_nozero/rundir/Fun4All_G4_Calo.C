...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_pythia8_PhotonJet5_2MHz-0000000015-00000.root",
    const string &outputFile = "DST_CALO_NOZERO_pythia8_PhotonJet5_2MHz-0000000015-00000.root",
    const string &outdir = ".",
