...
if ($#ARGV < 1)
{
    print "usage: run_all.pl <number of jobs> <\"Jet5\", \"Jet8\", <\"Jet10\" <\"Jet12\", \"Jet15\", \"Jet20\", \"Jet30\", \"Jet40\", \"Jet50\", \"Jet60\", \"Jet70\", \"Jet80\", \"PhotonJet\", \"PhotonJet5\", \"PhotonJet10\", \"PhotonJet20\" or \"Detroit\" production>\n";
    print "parameters:\n";
...
{
    print "second argument has to be Jet5, Jet8, Jet10, Jet15, Jet20, Jet30, Jet40, Jet50, Jet60, Jet70, Jet80, PhotonJet, PhotonJet5, PhotonJet10, PhotonJet20 or Detroit\n";
    exit(1);
}
...
close(F);
my $jettriggerWithUnderScore = sprintf("%s_pythia8_Detroit-",$jettrigger);
...
#    print "found $lfn\n";
	...
	foreach my $type (sort keys %outfiletype)
	{
            my $lfn =  sprintf("%s_pythia8_%s_pythia8_Detroit-%010d-%06d.root",$type,$jettrigger,$runnumber,$segment);
#            print "checking for $lfn\n";
	...
	my $calooutfilename = sprintf("DST_CALO_CLUSTER_pythia8_%s_pythia8_Detroit-%010d-%06d.root",$jettrigger,$runnumber,$segment);
	my $globaloutfilename = sprintf("DST_MBD_EPD_pythia8_%s_pythia8_Detroit-%010d-%06d.root",$jettrigger,$runnumber,$segment);
