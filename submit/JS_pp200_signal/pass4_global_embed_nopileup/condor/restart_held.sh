...
fm=0_20fm
withhijingbkg=50kHz_bkg_0_20fm
#exit 0
condor_q | grep ' H ' | grep run_pass4_global_embed_nopileup_js.sh  | grep ${fm} | grep -v ${withhijingbkg} | grep ${variable} | grep ${runnumber} > bla
