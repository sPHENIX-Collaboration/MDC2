...
int Fun4All_G4_sPHENIX_jobC(
  ...
  const std::string &inputFile1 = "DST_TRACKSEEDS_pythia8_Jet30_sHijing_0_20fm-0000000030-00000.root",
  const std::string &inputFile2 = "DST_CALO_CLUSTER_pythia8_Jet30_sHijing_0_20fm-0000000030-00000.root",
  const std::string &outputFile = "DST_TRACKS_pythia8_Jet30_sHijing_0_20fm-0000000030-00000.root",
