...
then
    ...
    rsync -av /sphenix/u/sphnxpro/MDC2/submit/JS_pp200_signal/pass4trk/rundir/* .
    getinputfiles.pl $2
    if [ $? -ne 0 ]
    then
...
filename=JS_pp200_signal_pass4trk_$5
...
rsyncdirname=/sphenix/user/sphnxpro/prmon/JS_pp200_signal/pass4trk_$5
if [ ! -d $rsyncdirname ]
then
