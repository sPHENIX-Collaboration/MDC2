...
if ($#ARGV < 1)
{
    print "usage: run_all.pl <number of jobs> <\"Jet5\">, \"Jet8\", \"Jet10\">, \"Jet12\">, <\"Jet15\">, <\"Jet30\">, <\"Jet40\">, <\"Jet50\">, <\"Jet60\">, <\"Jet70\">, <\"Jet80\">, \"PhotonJet\">, \"PhotonJet5\">, \"PhotonJet10\">, \"PhotonJet20\">, \"Detroit\">  production>\n";
    print "parameters:\n";
...
my $jettriggerWithDash = sprintf("%s_pythia8_Detroit-",$jettrigger);
...
while (my @res = $getfiles->fetchrow_array())
{
    ...
    if ($lfn =~ /(\S+)-(\d+)-(\d+).*\..*/ )
    {
        my $runnumber = int($2);
        my $segment = int($3);
        my $outfilename = sprintf("DST_TRUTH_JET_pythia8_%s_pythia8_Detroit-%010d-%06d.root",$jettrigger,$runnumber,$segment);
