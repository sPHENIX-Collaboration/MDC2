...
int Fun4All_G4_Calo(
    const int nEvents = 1,
    const string &inputFile0 = "DST_CALO_G4HIT_pythia8_Jet30_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000007-00000.root",
    const string &outputFile = "DST_CALO_NOZERO_pythia8_Jet30_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000007-00000.root",
    const string &outdir = ".",
