...
{
    print "second argument has to be Jet5, Jet8, Jet10, Jet12, Jet20, Jet30, Jet40, Jet50, Jet60, Jet70, Jet80, PhotonJet, PhotonJet5, PhotonJet10, PhotonJet20 or Detroit\n";
    exit(1);
}
