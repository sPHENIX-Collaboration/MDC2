...
int Fun4All_G4_Global(
    const int nEvents = 0,
    const std::string &inputFile1 = "DST_TRACKS_pythia8_Jet10_sHijing_0_20fm-0000000030-00000.root",
    const std::string &inputFile2 = "DST_MBD_EPD_pythia8_Jet10_sHijing_0_20fm-0000000030-00000.root",
    const std::string &outputFile = "DST_GLOBAL_pythia8_Jet10_sHijing_0_20fm-0000000030-00000.root",
