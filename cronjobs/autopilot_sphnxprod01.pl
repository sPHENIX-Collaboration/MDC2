...
#    "JS_pp200_signal/pass2/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass3calo/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass3trk/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass3_mbdepd/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass4jet/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass4_job0/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass4_jobA/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass4_jobC/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass5_global/condor" => ("pileup --run 29 --build ana.559"),
#    "JS_pp200_signal/pass5_truthreco/condor" => ("pileup --run 29 --build ana.559"),
...
#    "JS_pp200_signal/pass2_nopileup/condor" => ("--build ana.564 --run 28 --disable_trk --disable_mbd"),
#    "JS_pp200_signal/pass2_nopileup/condor" => ("--build ana.559 --run 29"),

# double collisions
    "JS_pp200_signal/pass2_double_nopileup/condor" => ("--build ana.564 --run 38 --disable_trk --disable_mbd"),
...
my @jettriggers = ("Jet8", "Jet12", "Jet20", "Jet30", "Jet40", "Jet50", "Jet60", "Jet70", "Jet80");
#my @jettriggers = ("Jet5", "Jet8", "Jet12", "Jet20", "Jet30", "Jet40", "Jet50", "Jet60", "Jet80", "PhotonJet5", "PhotonJet10", "PhotonJet20");
#my @jettriggers = ("Jet3", "Jet5", "Jet8", "Jet10", "Jet12", "Jet15", "Jet20", "Jet30", "Jet40", "Jet50", "Jet60", "Jet70", "Jet80", "Detroit", "PhotonJet3, "PhotonJet5", "PhotonJet10", "PhotonJet20");
