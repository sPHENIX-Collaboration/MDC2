...
my %submitdir = (
    ...
    #    "JS_pp200_signal/pass3_global_nopileup/condor" => ("--build ana.536 --run 29"),
    #    "JS_pp200_signal/pass2jet_nopileup/condor" => ("--build ana.536 --run 29"),
    #    "JS_pp200_signal/pass2_nopileup/condor" => ("--build ana.536 --run 29 --disable_trk"),
    ...
    "OO_0_15fm/pass2_nopileup/condor" => ("--run 35 --build ana.551"),
    "OO_0_15fm/pass3_job0_nopileup/condor" => ("--run 35 --build ana.551"),
    "OO_0_15fm/pass3_jobA_nopileup/condor" => ("--run 35 --build ana.551"),
    "OO_0_15fm/pass3_jobC_nopileup/condor" => ("--run 35 --build ana.551"),
    "OO_0_15fm/pass4_global_nopileup/condor" => ("--run 35 --build ana.551"),
    "OO_0_15fm/pass4_truthreco_nopileup/condor" => ("--run 35 --build ana.551"),

    # OO with pileup
    #    "OO_0_15fm/pass2/condor" => ("--build ana.533 --run 34 0 --pileup 220kHz"),
    "OO_0_15fm/pass3trk/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass3calo/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass3_mbdepd/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass4_job0/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass4_jobA/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass4_jobC/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass5_global/condor" => ("--build ana.551 --run 35 0 pileup"),
    "OO_0_15fm/pass5_truthreco/condor" => ("--build ana.551 --run 35 0 pileup"),
...
my @jettriggers = ("Eta3", "Eta8");
#my @jettriggers = ("Eta3", "Eta8", "Jet5", "Jet8", "Jet10", "Jet12", "Jet15", "Jet20", "Jet30", "Jet40", "Jet50", "Jet60", "Jet70", "Jet80", "Detroit", "PhotonJet5", "PhotonJet10", "PhotonJet20");
#my @singleparticles = {"gamma 10000 10000"};
my @pileups = ("1000kHz");
my @oopileups = ("140kHz", "220kHz","400kHz");
my @runs = ("28", "30");
...
foreach my $subdir ( keys %submitdir)
{
	...
	if ($submitargs =~ /pileup/)
	{
	    my $newsubmitargs = $submitargs;
	    $newsubmitargs =~ s/pileup//;
	    foreach my $pup (@oopileups)
	    {
		my $submitcmd = sprintf("perl run_all.pl %d -inc %s --pileup %s",$nsubmit,$newsubmitargs,$pup);
		condorcheck();
		print "executing $submitcmd in $newdir\n";
		system($submitcmd);
	    }
