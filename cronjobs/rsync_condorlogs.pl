...
push(@passes,"pass2_double_nopileup");
push(@passes,"pass2_embed");
push(@passes,"pass2_embed_nopileup");
push(@passes,"pass2_embed_nopileup_oo");
push(@passes,"pass2_embed_pau");
push(@passes,"pass2_pi0_embed");
push(@passes,"pass2_nopileup");
push(@passes,"pass2calo_nozero_nopileup");
push(@passes,"pass2calo_waveform_nopileup");
push(@passes,"pass2jet_nopileup");
push(@passes,"pass2jet_double_nopileup");
...
push(@passes,"pass3calo_embed_nopileup_oo");
...
push(@passes,"pass3_global_nopileup");
push(@passes,"pass3_global_double_nopileup");
push(@passes,"pass3jet_embed");
push(@passes,"pass3jet_embed_nopileup");
push(@passes,"pass3jet_embed_nopileup_oo");
...
push(@passes,"pass3_mbdepd");
push(@passes,"pass3_mbdepd_embed_nopileup");
push(@passes,"pass3_mbdepd_embed_nopileup_oo");
...
push(@passes,"pass4_global_embed_nopileup_oo");
