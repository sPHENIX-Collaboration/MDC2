...
#"fm_0_20/pass4_job0_nopileup/condor",
#"fm_0_20/pass4_jobA_nopileup/condor",
#"fm_0_20/pass4_jobC_nopileup/condor",
...
foreach my $subdir (@submitdir)
{
	...
	{
	    my $submitcmd = sprintf("perl run_all.pl 5000 %s -inc -shared",$qf);
