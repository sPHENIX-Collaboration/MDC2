...
void Fun4All_G4_EventCombine(int nEvents = 10, const int irun = 251, const int sequence = 1, const std::string &topdir = "/sphenix/lustre01/sphnxpro/mdc2/rawdata/stripe5", int nrepeat = 20)
{
